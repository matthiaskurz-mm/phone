	...
	this.initialize = function () {
		...
		window.localStorage.setItem("sessions", JSON.stringify(
			[
				...
				{
					"id": 1,
					"title": "Enterprise: Not just a dirty word any more",
					"firstName": "Bruce",
					"lastName": "Lefebvre",
					"pic": "bruce_lefebvre.png",
					"time": "11:00am",
					"room": "Ballroom C",
					"twitter_id": "brucelefebvre",
					"description": "This talk will focus on the integration of Adobe Experience Manager (AEM) and PhoneGap, affectionately known as PhoneGap Enterprise. We'll cover why you should care (hint: $) and bring you up to speed on what the platform can do for you and your clients."
				},
				{
					"id": 2,
				...
				{
					"id": 5,
					"title": "Sneak Peek: Adobe Experience Manager and Mobile",
					"firstName": "Anthony",
					"lastName": "Rumsey",
					"pic": "anthony.jpeg",
					"time": "4:45pm",
					"room": "Ballroom A",
					"twitter_id": "planetrumsey",
				...
				{
					"id": 9,
					"title": "Workshop: Build a PhoneGap App with Ionic+AngularJS",
					"firstName": "Holly",
					"lastName": "Schinsky",
					"pic": "holly.jpg",
					"time": "3:00pm",
